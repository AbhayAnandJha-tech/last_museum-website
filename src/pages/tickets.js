  ...
  return (
    <div className="tickets-page">
      <div className="container">
        ...
        <p>
          Plan your visit to our museum by selecting the tickets and events you
          wish to explore!
        </p>
        ...
        <form id="ticket-form" onSubmit={handleSubmit}>
          ...
          <div className="form-group inline">
            ...
            <label htmlFor="terms">
              I agree to the{" "}
              <a
                href="https://www.nationalsciencecentre.in/terms-and-conditions"
                target="_blank"
                rel="noopener noreferrer"
              >
          ...
          <button type="submit" className="submit-btn" disabled={!termsChecked}>
            Proceed to Payment
          </button>
        </form>
      </div>
