      ...
      <div className="about-container">
        <div className="about-header">
          ...
          <p className="about-intro">
            ...
            Science Museums, is one of the largest science centers in Asia. We
            are committed to engaging, educating, and entertaining visitors
        ...
        <div className="about-content">
          ...
          <section className="about-why-visit">
            <h2>Why Visit Us?</h2>
            <p>
              Explore hands-on exhibits, engaging demonstrations, and a variety
              of interactive activities designed to ignite curiosity and foster
              a love of science. Our iconic modern architecture and strategic
